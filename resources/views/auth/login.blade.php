...
<!-- Mirrored from affixtheme.com/html/xmee/demo/login-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 04 Jan 2021 16:23:39 GMT -->
<head>
	<meta charset="utf-8">
					...
					<div class="fxt-content">
						<div class="fxt-header">
							...
							<div class="fxt-page-switcher">
								<a href="{{url('register')}}" class="btn btn-light btn-outline-danger">Register</a>
							</div>
						</div>
						<div class="fxt-form">
							<h2>Log In</h2>
							<p>Log in to continue in User Profile</p>
...
<!-- Mirrored from affixtheme.com/html/xmee/demo/login-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 04 Jan 2021 16:23:47 GMT -->
</html>